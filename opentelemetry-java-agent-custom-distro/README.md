...
This directory is a copy of distro example from opentelemetry java agent (1.22.0 at the time). 
You can find in the instrumentation/jmx-elastic how to add a custom instrumentation into a final custom opentelemetry Java Agent.
